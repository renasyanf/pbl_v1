...
class __AlfalaqState extends State<_AlfalaqState> {
  ...
  void initState() {
    ...
    audioPaths = [
      'assets/audio/alfalaq/AYAT1.mp3',
      'assets/audio/alfalaq/AYAT2.mp3',
      'assets/audio/alfalaq/AYAT3.mp3',
      'assets/audio/alfalaq/AYAT4.mp3',
      'assets/audio/alfalaq/AYAT5.mp3',
    ];
