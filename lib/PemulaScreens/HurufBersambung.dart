...
class HurufBersambung extends StatelessWidget {
  const HurufBersambung({super.key});
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Column(
                      ...
                      children: <Widget>[
                        PemulaButton(
                           text: '        Huruf Hijaiyah Bersendirian\nCara Huruf Dipotong dan Disambung',
                          onPressed: () => _navigateToDarjah1(context),
                        ),
                        const SizedBox(height: 15),
                        PemulaButton(
                          text: 'Pengenalan Font daripada Makhraj Yang Sama',
                          onPressed: () => _navigateToDarjah2(context),
                        ),
                        const SizedBox(height: 15),
                        PemulaButton(
                          text: 'Huruf di tengah Bersambung',
                          onPressed: () => _navigateToDarjah2(context),
                        ),
                        const SizedBox(height: 15),
                        PemulaButton(
                          text: 'Mengenal Huruf Hijaiyah di surah Al Fatihah',
                          onPressed: () => _navigateToDarjah2(context),
                        ),
                      ],
                    ),
