...
class Alpabhetrumi extends StatelessWidget {
  const Alpabhetrumi({super.key});
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Column(
                      ...
                      children: <Widget>[
                        PemulaButton(
                          text: 'Mengenal Huruf Hijaiyah Dengan Nombor Arab',
                          onPressed: () => _navigateToDarjah1(context),
                        ),
                        const SizedBox(height: 15),
                        PemulaButton(
                          text: 'Belajar Huruf Hijaiyah Dengan Mengenal Kedudukan Titik',
                          onPressed: () => _navigateToDarjah2(context),
                        ),
                        const SizedBox(height: 15),
                        PemulaButton(
                          text: 'Huruf dan Titik',
                          onPressed: () => _navigateToDarjah2(context),
                        ),
                        const SizedBox(height: 15),
                        PemulaButton(
                          text: 'Mengenal Huruf Hijaiyah Menggunakan Tekap',
                          onPressed: () => _navigateToDarjah2(context),
                        ),
                      ],
                    ),
